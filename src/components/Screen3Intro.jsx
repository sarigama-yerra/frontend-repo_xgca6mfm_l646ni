...
export default function Screen3Intro() {
  ...
  return (
    <section className="relative min-h-[120vh] overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5" style={{backgroundImage:"url('data:image/svg+xml;utf8,<svg xmlns=\\"http://www.w3.org/2000/svg\\" viewBox=\\"0 0 800 600\\\"><filter id=\\"m\\\"><feTurbulence type=\\"fractalNoise\\" baseFrequency=\\"0.8\\" numOctaves=\\"2\\"/></filter><rect width=\\"800\\" height=\\"600\\" filter=\\"url(%23m)\\"/></svg>')"}} />
